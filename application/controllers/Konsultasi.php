...
class Konsultasi extends CI_Controller {
	...
	function reply(){
		if (isset($_POST['submit'])){
			$data = array('reply'=>cetak($this->input->post('a',TRUE)),
                            'nama_lengkap'=>cetak($this->input->post('b',TRUE)),
                            'alamat_email'=>cetak($this->input->post('c',TRUE)),
                            'isi_pesan'=>cetak($this->input->post('d',TRUE)),
