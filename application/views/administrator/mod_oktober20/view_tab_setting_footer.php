                                        ...
                                        <li class="item-setting-footer"> 
                                            <div class="card ">
                                                ...
                                                <div class="card-body form-template d-none">
                                                    ...
                                                    switch ($widget_key) {
                                                        case 'widget_video':
                                                            oktober20_control_widget_video($wi,$widget_key,array(),$get_playlist_dropdown,'setting_footer');
                                                            break;
                                                        case 'widget_gallery':
                                                            oktober20_control_widget_gallery($wi,$widget_key,array(),$get_album_dropdown,'setting_footer');
                                                            break;
                                                        case 'widget_iklan_sidebar':
                                                            oktober20_control_iklan_sidebar($wi,$widget_key,array(),$get_iklan_sidebar_dropdown,'setting_footer');
                                                            break;
                                                        case 'widget_iklan_link':
                                                            oktober20_control_iklan_link($i,$id,array(),$get_iklan_link_list,'setting_footer');
                                                            break;
                                                        case 'widget_menu':
                                                            oktober20_control_widget_menu($wi,$widget_key,array(),$get_menu_dropdown,'setting_footer');
                                                            break; 
                                                        default:
                                                            oktober20_control_widget($wi,$widget_key,array(),'setting_footer');
                                                            break;
                                                    } 
                                                    ?> 
                                                </div>
                                                ...
                                                <li class="item-setting-footer dd-item" data-id="<?php echo $id;?>">
                                                    ...
                                                    <div class="card collapsed-card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            switch ($id) {
                                                                case 'widget_video':
                                                                    oktober20_control_widget_video($i,$id,$get_setting_footer,$get_album_dropdown, $param_name);
                                                                    break;
                                                                case 'widget_gallery':
                                                                    oktober20_control_widget_gallery($i,$id,$get_setting_footer,$get_album_dropdown, $param_name);
                                                                    break;
                                                                case 'widget_iklan_sidebar':
                                                                    oktober20_control_iklan_sidebar($i,$id,$get_setting_footer,$get_iklan_sidebar_dropdown, $param_name);
                                                                    break;
                                                                case 'widget_iklan_link':
                                                                    oktober20_control_iklan_link($i,$id,$get_setting_footer,$get_iklan_link_list, $param_name);
                                                                    break;
                                                                case 'widget_menu': 
                                                                    oktober20_control_widget_menu($i,$id,$get_setting_footer,$get_menu_dropdown, $param_name);
                                                                    break; 
                                                                default:
                                                                    oktober20_control_widget($i,$id,$get_setting_footer, $param_name);
                                                                    break;
                                                            }   
                                                            ?>
                                                        </div>
                ...
                '<div class="card collapsed-card">'+
                    '<div class="card-header  bg-info">'+
                        ...
                        '<div class="card-tools">'+
                            ...
                            '<button type="button" class="setting-footer-widget-remove btn btn-tool"><i class="fas fa-trash-alt"></i></button>' +
                        '</div>'+
                    '</div>'+
                    '<div class="card-body">'+
                        widgetFormElement +
