<?php echo form_open($this->uri->segment(1)."/oktober20",array( 'class'=> 'form-horizontal pt-4' )) ;?>
    ...
    <div class="card" style="min-height:450px">
        ...
        <div class="card-body"> 
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <select name="lokasi_menu[menu_top]" class="form-control">
                        <option value="" <?php echo (empty($get_lokasi_menu['menu_top'])) ? 'selected="selected"' : '';?>>-- Pilih Menu --</option>
                        <?php if(!empty($get_menu_dropdown)){
                            foreach($get_menu_dropdown as $item_menu){ 
                                ?>
                                <option value="<?php echo $item_menu['id'];?>" 
                                    <?php echo ($get_lokasi_menu['menu_top'] ==  $item_menu['id']) ? 'selected="selected"' : '';?>>
                                    <?php echo $item_menu['nama'];?>
                                </option>
                                <?php
                            }
...
<div class="callout callout-info">
    ...
    <ul>
        ...
        <li>Lokasi "Top  Menu"  hanya mendukung 1 level saja.</li>
