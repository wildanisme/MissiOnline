            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <select name="iklan_header" class="form-control">
                        ...
                        <option value="semua-acak"  <?php echo ($get_iklan_header == 'semua-acak') ? 'selected="selected"' : '';?>>Semua ( Acak )</option>
                        <?php 
...
<div class="callout callout-info">
    ...
    <ul> 
        ...
        <li>Iklan Header / Atas untuk mengatur visibiliti iklan atas/header.</li> 
