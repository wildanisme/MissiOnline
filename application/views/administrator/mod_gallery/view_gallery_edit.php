...
echo "
              <div class='card card-info'>
                <div class='card-header with-border'>
                  <h3 class='card-title'>Edit Gallery tulisan Foto</h3>
                </div>
              <div class='card-body'>";
...
if ($rows['gbr_gallery'] != '') {
  echo " Gambar Saat ini : <a target='_BLANK' href='" . base_url() . "asset/img_galeri/$rows[gbr_gallery]'>$rows[gbr_gallery]</a>";
}
echo "</td></tr>
                  </tbody>
                  </table>
