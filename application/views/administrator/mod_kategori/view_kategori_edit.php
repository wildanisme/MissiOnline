...
echo "
              <div class='card card-info'>
                <div class='card-header with-border'>
                  <h3 class='card-title'>Edit Kategori tulisan</h3>
                </div>
              <div class='card-body'>";
$attributes = array('class' => 'form-horizontal', 'role' => 'form');
echo form_open_multipart($this->uri->segment(1) . '/edit_kategoritulisan', $attributes);
echo "
...
if ($rows['gambar_utama'] != '') {
  echo "Lihat Gambar : <a target='_BLANK' href='" . base_url() . "asset/foto_tulisan/$rows[gambar_utama]'>$rows[gambar_utama]</a>";
}
echo "</td></tr>
                  </tbody>
                  </table>
              ...
              <div class='card-footer'>
                    ...
                    <a href='" . base_url() . $this->uri->segment(1) . "/kategoritulisan'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
