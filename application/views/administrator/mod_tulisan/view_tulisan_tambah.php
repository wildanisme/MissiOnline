...
echo "<div class='card'>
                <div class='card-header with-border'>
                  <h3 class='card-title'>Tambah tulisan Baru </h3>
                </div>
              <div class='card-body'>";
$attributes = array('class' => 'form-horizontal', 'role' => 'form');
echo form_open_multipart($this->uri->segment(1) . '/tambah_listtulisan', $attributes);
...
echo "</td></tr>
                    ...
                    <tr><th scope='row'>Tulisan Utama</th>           <td><input type='radio' name='g' value='Y'> Ya &nbsp; <input type='radio' name='g' value='N' checked> Tidak</td></tr>
                    <tr><th scope='row'>Isi Tulisan</th>             <td><textarea id='editor1' class='form-control' name='h' style='height:480px' required></textarea></td></tr>
