...
echo "
              <div class='card card-info'>
                <div class='card-header with-border'>
                  <h3 class='card-title'>Edit Komentar tulisan</h3>
                </div>
              <div class='card-body'>";
$attributes = array('class' => 'form-horizontal', 'role' => 'form');
echo form_open_multipart($this->uri->segment(1) . '/edit_komentartulisan', $attributes);
echo "
...
echo "</td></tr>
              ...
              <div class='card-footer'>
                    ...
                    <a href='" . base_url() . $this->uri->segment(1) . "/komentartulisan'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
