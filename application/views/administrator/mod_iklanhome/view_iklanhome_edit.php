...
$data = array('home', 'home_tengah', 'home_bawah', 'tulisan_detail', 'detail_video', 'tulisan_foto', 'hal_download', 'detail_agenda', 'hal_statis');
...
if ($rows['gambar'] != '') {
  echo "Lihat Gambar : <a target='_BLANK' href='" . base_url() . "asset/foto_iklantengah/$rows[gambar]'>$rows[gambar]</a>";
}
echo "</td></tr>
    </tbody>
    </table>
