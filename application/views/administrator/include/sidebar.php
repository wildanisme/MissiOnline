    ...
    <ul class="nav nav-pills nav-sidebar flex-column nav-flat menu-open nav-legacy nav-compact" data-widget="treeview" role="menu" data-accordion="false">
      ...
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          ...
          <p>Modul Tulisan <i class="right fas fa-angle-left"></i></p>
        </a>
        <ul class="nav nav-treeview">
          <?php
          $cek = $this->model_app->umenu_akses("listtulisan", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/listtulisan'><i class='far fa-circle nav-icon text-success'></i> <p>Tulisan</p></a></li>";
          }

          $cek = $this->model_app->umenu_akses("kategoritulisan", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/kategoritulisan'><i class='far fa-circle nav-icon text-success'></i> <p>Kategori Tulisan</p></a></li>";
          }

          $cek = $this->model_app->umenu_akses("tagtulisan", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/tagtulisan'><i class='far fa-circle nav-icon text-success'></i> <p>Tag Tulisan</p></a></li>";
          }

          $cek = $this->model_app->umenu_akses("komentartulisan", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/komentartulisan'><i class='far fa-circle nav-icon text-success'></i> <p>Komentar Tulisan</p></a></li>";
          }
          ...
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/album'><i class='far fa-circle nav-icon text-success'></i> <p>Tulisan Foto</p></a></li>";
          }

          $cek = $this->model_app->umenu_akses("gallery", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/gallery'><i class='far fa-circle nav-icon text-success'></i> <p>Gallery Tulisan Foto</p></a></li>";
          }
          ?>
        </ul>
      </li>
      ...
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          ...
          <p>Modul Video <i class="right fas fa-angle-left"></i></p>
        </a>
        <ul class="nav nav-treeview">
          <?php
      ...
      <li class="nav-item has-treeview">
        <a href="#" class="nav-link">
          ...
          <p>Modul Iklan <i class="right fas fa-angle-left"></i></p>
        </a>
        <ul class="nav nav-treeview">
          <?php
       ...
       */
      ?>
      <li class="nav-item has-treeview module-oktober20">
        <a href="#" class="nav-link">
          <i class="nav-icon fas fa-cogs"></i>
          <p>Modul Oktober20 <i class="right fas fa-angle-left"></i></p>
        </a>
        <ul class="nav nav-treeview">
          <?php
          //mod oktober20
          $cek = $this->model_app->umenu_akses("oktober20", $this->session->id_session);
          if ($cek == 1 or $this->session->level == 'admin') {
            echo "<li class='nav-item oktober20'><a class='nav-link' href='" . base_url() . $this->uri->segment(1) . "/oktober20'><i class='far fa-circle nav-icon text-success'></i> <p>Oktober20 Panel</p></a></li>";
          }
