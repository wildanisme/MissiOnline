                                        ...
                                        <li class="item-setting-sidebar"> 
                                            <div class="card ">
                                                ...
                                                <div class="card-body form-template d-none">
                                                    ...
                                                    switch ($widget_key) {
                                                        case 'widget_video':
                                                            goodnews_control_widget_video($wi,$widget_key,array(),$get_playlist_dropdown);
                                                            break;
                                                        case 'widget_gallery':
                                                            goodnews_control_widget_gallery($wi,$widget_key,array(),$get_album_dropdown);
                                                            break;
                                                        case 'widget_iklan_sidebar':
                                                            goodnews_control_iklan_sidebar($wi,$widget_key,array(),$get_iklan_sidebar_dropdown);
                                                            break;
                                                        case 'widget_iklan_link':
                                                            goodnews_control_iklan_link($i,$id,array(),$get_iklan_link_list);
                                                            break;
                                                        case 'widget_menu':
                                                            goodnews_control_widget_menu($wi,$widget_key,array(),$get_menu_dropdown);
                                                            break; 
                                                        default:
                                                            goodnews_control_widget($wi,$widget_key,array());
                                                            break;
                                                    } 
                                                    ?>
                                                </div>
                                        ...
                                        <li class="item-setting-sidebar dd-item" data-id="<?php echo $id;?>">
                                            ...
                                            <div class="card collapsed-card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    switch ($id) {
                                                        case 'widget_video':
                                                            goodnews_control_widget_video($i,$id,$get_setting_sidebar,$get_playlist_dropdown);
                                                            break;
                                                        case 'widget_gallery':
                                                            goodnews_control_widget_gallery($i,$id,$get_setting_sidebar,$get_album_dropdown);
                                                            break;
                                                        case 'widget_iklan_sidebar':
                                                            goodnews_control_iklan_sidebar($i,$id,$get_setting_sidebar,$get_iklan_sidebar_dropdown);
                                                            break;
                                                        case 'widget_iklan_link':
                                                            goodnews_control_iklan_link($i,$id,$get_setting_sidebar,$get_iklan_link_list);
                                                            break;
                                                        case 'widget_menu': 
                                                            goodnews_control_widget_menu($i,$id,$get_setting_sidebar,$get_menu_dropdown);
                                                            break; 
                                                        default:
                                                            goodnews_control_widget($i,$id,$get_setting_sidebar);
                                                            break;
                                                    }  
                                                    ?>
                                                </div>
