...
function goodnews_control_widget($index,$type,$value_widget,$param_name ='setting_sidebar'){
...
function goodnews_control_widget_menu($index,$type,$value_widget,$dropdown_menu,$param_name ='setting_sidebar'){
?>
    <div class="form-group">
        <label>Judul</label>
        <input data-name="judul" name="<?php echo $param_name; ?>[<?php echo $index;?>][<?php echo $type;?>][judul]" 
...
function goodnews_control_iklan_sidebar($index,$type,$value_widget,$dropdown_iklan,$param_name ='setting_sidebar'){
    ?>
        <div class="form-group">
            <label>Judul</label>
            <input data-name="judul" name="<?php echo $param_name; ?>[<?php echo $index;?>][<?php echo $type;?>][judul]" 
...
function goodnews_control_iklan_link($index,$type,$value_widget,$get_iklan_link_list,$param_name ='setting_sidebar'){
    ?>
        <div class="form-group">
            <label>Judul</label>
            <input data-name="judul" name="<?php echo $param_name; ?>[<?php echo $index;?>][<?php echo $type;?>][judul]" 
...
function goodnews_control_widget_gallery($index,$type,$value_widget,$dropdown_album,$param_name ='setting_sidebar'){
?> 
    <div class="form-group">
        <label>Judul</label>
        <input data-name="judul" name="<?php echo $param_name; ?>[<?php echo $index;?>][<?php echo $type;?>][judul]" 
...
function goodnews_control_widget_video($index,$type,$value_widget,$dropdown_playlist,$param_name ='setting_sidebar'){
?> 
    <div class="form-group">
        <label>Judul</label>
        <input data-name="judul" name="<?php echo $param_name; ?>[<?php echo $index;?>][<?php echo $type;?>][judul]" 
