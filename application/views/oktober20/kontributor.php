	...
	<div class="card-body">
		<div class="card-text">
			<div class="alert alert-warning">
				...
				<p>
					Untuk berkontribusi dalam memberikan atau menulis artikel/tulisan,
			...
			<form class="form" action="<?php echo base_url(); ?>kontributor/pendaftaran" method="POST" enctype='multipart/form-data' onSubmit="return validasireg(this)">
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<input class="form-control" type="password" placeholder="Password" name='b' id="c_name" required />
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 form-group">
