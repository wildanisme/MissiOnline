		...
		<div class="blog-detail card mb-4">
			<div class="card-body">
				...
				<div class="post-meta">
					...
					<i class="fa fa-clock-o"></i> <?php echo tgl_indo($rows['tgl_posting']); ?> ,
					<i class="fa fa-flash" aria-hidden="true"></i> dilihat <?php echo get_viewer($rows['hits_album']); ?>
				</div>
...
<?php
$bfiklan = $this->model_utama->view_where_ordering_limit('iklantengah', array('posisi' => 'tulisan_foto'), 'id_iklantengah', 'ASC', 0, 5);
