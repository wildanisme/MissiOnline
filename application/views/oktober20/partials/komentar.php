<?php if ($total_komentar > 0) { ?>
	<div class="card my-4" id="listcomment">
		<div class="card-body">
			<h3 class="comments"><?php echo "Ada $total_komentar Komentar untuk tulisan Ini"; ?>
			...
			<ol class="commentlist">
				...
				foreach ($komentar->result_array() as $komentar_tulisan) {
					$isian = nl2br($komentar_tulisan['isi_komentar']);
					$komentarku = sensor($isian);
					$class_list = 'even';
					if (($no % 2) == 0) {
						$class_list = 'odd';
					}
					$avatar = md5(strtolower(trim($komentar_tulisan['email'])));
				?>
					<li class="comment <?php echo $class_list; ?>">
						...
						<div class="comment-author">
							<a href="<?php echo $komentar_tulisan['url']; ?>">
								<?php echo $komentar_tulisan['nama_komentar']; ?>
							</a>
						</div>
						<div class="comment-metadata">
							<i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo tgl_indo($komentar_tulisan['tgl']); ?>
						</div>
...
<div class="comment-respond" id="writecomment">
	...
	<?php echo form_open('komentar-tulisan', array('class' => 'comment-form', 'id' => 'form_komentar')); ?>
	<input type="hidden" name='tulisan' value='<?php echo "$rows[id_tulisan]"; ?>'>
	<?php
