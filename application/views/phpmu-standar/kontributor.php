<script type="text/javascript">
	function validasireg(form) {
		...
		if (form.e.value == "") {
			alert("Anda belum menuliskan No Telpon");
			form.e.focus();
			return (false);
		}
		return (true);
			...
			<div class="block">
				...
				<div class="block-content">
					<div class="shortcode-content">
						<div class="column12">
							<div id="writecomment">
								<p><label for="c_name"><b style='color:red'>PENTING!</b></label><i>Untuk berkontribusi dalam memberikan atau menulis artikel/tulisan, maka Silahkan Melengkapi form dibawah ini dengan data yang sebenarnya. Terima kasih,.. ^_^</i></p><br>
								...
								<form action="<?php echo base_url(); ?>kontributor/pendaftaran" method="POST" enctype='multipart/form-data' onSubmit="return validasireg(this)">
									<p class="contact-form-user">
										...
										<input type="text" placeholder="Nickname" name='a' id="c_name" onkeyup="nospaces(this)" required />
									</p>
									<p class="contact-form-user">
										<label for="c_name">Password<span class="required">*</span></label>
										<input type="text" placeholder="Password" name='b' id="c_name" required />
									</p>
									<p class="contact-form-user">
										<label for="c_name">Nama Lengkap<span class="required">*</span></label>
										<input type="text" placeholder="Nama Lengkap" name='c' id="c_name" required />
									</p>
									<p class="contact-form-email">
										<label for="c_email">E-mail<span class="required">*</span></label>
										<input type="text" placeholder="E-mail" name='d' id="c_email" required />
									</p>
									<p class="contact-form-email">
