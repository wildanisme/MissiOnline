...
<div class="widget">
	...
	<div class="widget-articles">
		<ul>
			<li>
				<?php
				$terbaru = $this->model_utama->view_join_two('tulisan', 'users', 'kategori', 'username', 'id_kategori', array('tulisan.status' => 'Y', 'tulisan.utama' => 'Y',), 'tanggal', 'DESC', 0, 3);
	...
	<div class="widget-comments">
		<ul>
			...
			foreach ($komentar->result_array() as $r) {
				...
				$b = $this->model_utama->view_where('tulisan', array('id_tulisan' => $r['id_tulisan']))->row_array();
