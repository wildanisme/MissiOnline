    <div id="jssor_1" class='jssor_1'>
        ...
        <div data-u="slides" class='slides'>
            <?php
            $slide1 = $this->model_utama->view_join_two('tulisan', 'users', 'kategori', 'username', 'id_kategori', array('headline' => 'Y', 'status' => 'Y'), 'id_tulisan', 'DESC', 0, 4);
            $no = 1;
            foreach ($slide1->result_array() as $row) {
                ...
                echo "<div>
                            <img data-u='image' src='" . base_url() . "asset/foto_tulisan/$foto_slide'/>
