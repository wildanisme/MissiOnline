			...
			<div class="content-block main left">
				<div class="block">
					<div class="block-title" style="background: #2182b4;">
						...
						<h2>tulisan Kategori "<?php echo "$rows[nama_kategori]"; ?>"</h2>
					</div>
					<div class="block-content">
						<ul class="article-block">
							<?php
							foreach ($tulisankategori->result_array() as $r) {
								$baca = $r['dibaca'] + 1;
							...
							<div style='height:120px; background:#e3e3e3; overflow:hidden; margin-right:10px' class='article-photo hidden-xs'>
								...
								if ($r['gambar'] == '') {
									echo "<img style='width:210px;' src='" . base_url() . "asset/foto_tulisan/no-image.jpg' alt='no-image.jpg' /></a>";
								} else {
									echo "<img style='width:210px;' src='" . base_url() . "asset/foto_tulisan/$r[gambar]' alt='$r[gambar]' /></a>";
								}
								echo "</a>
							</div>
							<div class='article-photo visible-xs'>";
								if ($r['gambar'] == '') {
									echo "<a class='hover-effect' href='" . base_url() . "$r[judul_seo]'><img style='width:59px; height:42px' src='" . base_url() . "asset/foto_tulisan/small_no-image.jpg' alt='small_no-image.jpg' /></a>";
								} else {
									echo "<a class='hover-effect' href='" . base_url() . "$r[judul_seo].html'><img style='width:59px; height:42px' src='" . base_url() . "asset/foto_tulisan/$r[gambar]' alt='$r[gambar]' /></a>";
								}
								echo "</div>
