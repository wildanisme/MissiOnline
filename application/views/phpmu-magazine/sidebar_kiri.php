...
<div class="block">
	<h2 style='color:#000; border-bottom: 2px solid #000;' class="list-title">tulisan Foto</h2>
...
<div class="block">
	...
	<h2 class="list-title" style="color: #c42b20;border-bottom: 2px solid #c42b20;">tulisan <?php echo "$rh[nama_kategori]"; ?></h2>
	<ul class="article-block">
		<?php
		$kategori3 = $this->model_utama->view_join_two('tulisan', 'users', 'kategori', 'username', 'id_kategori', array('tulisan.id_kategori' => $rh['id_kategori'], 'tulisan.status' => 'Y'), 'id_tulisan', 'DESC', 0, 5);
		foreach ($kategori3->result_array() as $r2z) {
			$total_komentar = $this->model_utama->view_where('komentar', array('id_tulisan' => $r2z['id_tulisan']))->num_rows();
			echo "<li>
						<div class='article-photo'>";
			if ($r2z['gambar'] == '') {
				echo "<a href='" . base_url() . "$r2z[judul_seo]' class='hover-effect'><img style='width:59px; height:42px;' src='" . base_url() . "asset/foto_tulisan/small_no-image.jpg' alt='' /></a>";
			} else {
				echo "<a href='" . base_url() . "$r2z[judul_seo]' class='hover-effect'><img style='width:59px; height:42px;' src='" . base_url() . "asset/foto_tulisan/$r2z[gambar]' alt='' /></a>";
			}
			echo "</div>
						<div class='article-content'>
...
<div class="block">
	...
	<h2 class="list-title" style="color: #2277c6;border-bottom: 2px solid #2277c6;">tulisan <?php echo "$rhx[nama_kategori]"; ?></h2>
	<ul class="article-block">
		<?php
		$kategori4 = $this->model_utama->view_join_two('tulisan', 'users', 'kategori', 'username', 'id_kategori', array('tulisan.id_kategori' => $rhx['id_kategori'], 'tulisan.status' => 'Y'), 'id_tulisan', 'DESC', 0, 5);
...
<div class="block">
	...
	<h2 class="list-title" style="color:green; border-bottom: 2px solid green;">tulisan <?php echo "$rha[nama_kategori]"; ?></h2>
	<ul class="article-block">
		<?php
		$kategori4 = $this->model_utama->view_join_two('tulisan', 'users', 'kategori', 'username', 'id_kategori', array('tulisan.id_kategori' => $rha['id_kategori'], 'tulisan.status' => 'Y'), 'id_tulisan', 'DESC', 0, 5);
		foreach ($kategori4->result_array() as $r2x) {
			$total_komentar = $this->model_utama->view_where('komentar', array('id_tulisan' => $r2x['id_tulisan']))->num_rows();
			echo "<li>
						<div class='article-photo'>";
