...
<div class="block">
	...
	<ul class="article-block">
		<?php
		$kategori5 = $this->model_utama->view_join_two('tulisan', 'users', 'kategori', 'username', 'id_kategori', array('tulisan.id_kategori' => $r['id_kategori'], 'tulisan.status' => 'Y'), 'id_tulisan', 'DESC', 0, 3);
