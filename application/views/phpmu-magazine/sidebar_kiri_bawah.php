<div class="block">
	...
	<h2 class="list-title" style="color: #dd8229;border-bottom: 2px solid #dd8229;">tulisan <?php echo "$r[nama_kategori]"; ?></h2>
	<ul class="article-block">
		<?php
		$kategori5 = $this->model_utama->view_join_two('tulisan', 'users', 'kategori', 'username', 'id_kategori', array('tulisan.id_kategori' => $r['id_kategori'], 'tulisan.status' => 'Y'), 'id_tulisan', 'DESC', 0, 5);
