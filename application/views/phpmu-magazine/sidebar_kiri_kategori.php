...
<div class="block">
	...
	if ($this->uri->segment(1) == 'video') {
		...
		echo "<h2 class='list-title' style='color: #2277c6; border-bottom: 2px solid #2277c6;''>tulisan $r[nama_kategori]</h2>
		<ul class='article-block'>";
		$kategori1 = $this->model_utama->view_join_two('tulisan', 'users', 'kategori', 'username', 'id_kategori', array('tulisan.id_kategori' => $r['id_kategori'], 'tulisan.status' => 'Y'), 'dibaca', 'DESC', 0, 5);
		...
		echo "<h2 class='list-title' style='color:#2277c6; border-bottom: 2px solid #2277c6;''>tulisan Populer</h2>
		<ul class='article-block'>";
		$populer = $this->model_utama->view_join_two('tulisan', 'users', 'kategori', 'username', 'id_kategori', array('tulisan.status' => 'Y'), 'dibaca', 'DESC', 0, 5);
