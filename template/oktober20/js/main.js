$(function(){
        ...
        $(".section-full-width .featured-item.owl-md-4").owlCarousel({
            items: 3,
            dots: false,
            autoplay: false,
            margin: 0,
        ...
        $(".section-with-sidebar .featured-item.owl-md-4").owlCarousel({
            items: 3,
            dots: false,
            autoplay: false,
            margin: 0,
        ...
        $(".section-full-width .featured-item.owl-md-3").owlCarousel({
            items: 4,
            dots: false,
            autoplay: false,
            margin: 0,
        ...
        $(".section-with-sidebar .featured-item.owl-md-3").owlCarousel({
            items: 4,
            dots: false,
            autoplay: false,
            margin: 0,
